...
class TestOneEdge(unittest.TestCase):
    ...
    def test_metamorphic1_small_vs_large_requirements(self):
        ...
        input = generate_input([p1, p2, p3, p4, p5, p6, p7])
    ...
    def test_permutations_lossRate(self):
        ...
        input = generate_input([p1, p2, p3, p4, p5, p6])
        lossRate1 = rl_v1(self.test_permutations_bp().bp1, input["arrival_rates"], input["service_rates"])
        lossRate2 = rl_v2(self.test_permutations_bp().bp1, input["arrival_rates"], input["service_rates"])
        lossRate3 = rl_v3(self.test_permutations_bp().bp3, input["arrival_rates"], input["service_rates"])
